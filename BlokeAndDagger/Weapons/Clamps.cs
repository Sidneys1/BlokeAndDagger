...
namespace BlokeAndDagger.Weapons {
    public class Clamps : Weapon {
        public override string BaseName { get; } = "Clamps";

        public override double BaseDamage { get; } = 4;

        public override DamageTypes DamageType { get; } = DamageTypes.Slicing|DamageTypes.Crushing;
